...
namespace IGLib.Core
{
    ...
    public abstract class ModelParameterSetFixedBase<ModelParameterType> : IModelParameterSetBaseFixed<ModelParameterType>
        where ModelParameterType: IModelParameter
    {
        ...
        public ModelParameterSetFixedBase(string title, string description, params ModelParameterType[] parameters)
        {
        ...
        public ModelParameterSetFixedBase(string title, string description, 
        ...
        {
            return ParametersDictionaryInternal.ContainsKey(key);
        }
