...
namespace IGLib.Core
{
    ...
    internal interface IModelParameterSet
    {
        ...
        IReadOnlyList<IModelParameter> ParameterList { get; }
        ...
        IModelParameter this[int whichParameter] { get; }
        ...
        IModelParameter this[string parameterName] { get; }
